<#
.SYNOPSIS
Sets Azure DevOps Server–related services to Automatic startup.

.DESCRIPTION
Updates the startup type for Azure Pipelines Agent, IIS, and SQL Server
services so they auto-start when the machine boots.

.EXAMPLE
.\Set-ADOServicesToAutomatic.ps1
#>
...
# Same service list used in Stop-ADOServices.ps1
$services = @(
...
Write-Host "Setting ADO Server Services to AUTOMATIC" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
