...
- [ ] **Tests:** Run unit and integration tests locally:
  - .NET: `dotnet test` (tests default to analyzers disabled in local runs; see `docs/run/RUN-LOCAL.md` for details)
...
- [ ] **Docs / Runbook:** If the change affects developer workflows (build, run, test), update `docs/run/RUN-LOCAL.md` or `docs/run/ANALYZERS.md` accordingly.
